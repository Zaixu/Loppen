...
{
    public class PGMapLauncher : BaseCommand
    {
        ...
        {
            SearchOptions searchOptions = WPCordovaClassLib.Cordova.JSON.JsonHelper.Deserialize<SearchOptions>(options);
        ...
        {
            var optionStrings = WPCordovaClassLib.Cordova.JSON.JsonHelper.Deserialize<string[]>(options);
            var directionOptions = WPCordovaClassLib.Cordova.JSON.JsonHelper.Deserialize<GetDirectionsOptions>(optionStrings[0]);
